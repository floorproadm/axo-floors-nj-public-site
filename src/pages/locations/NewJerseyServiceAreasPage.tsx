...
const HUB_PATH = "/service-areas/new-jersey";
const HUB_URL = `${PUBLIC_SITE_URL}${HUB_PATH}`;
  ...
  useEffect(() => {
    const breadcrumb = {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 2, name: "New Jersey Service Areas", item: HUB_URL },
      ],
    };
    const el = document.createElement("script");
    el.type = "application/ld+json";
    el.id = "ld-breadcrumb-nj-hub";
      ...
      <main className="bg-background">
        ...
        <nav aria-label="Breadcrumb" className="container mx-auto px-4 pt-6 text-sm">
          <ol className="flex flex-wrap items-center gap-1.5 text-grey">
            <li><Link to="/" className="hover:text-navy transition-smooth">Home</Link></li>
        ...
        <section className="container mx-auto px-4 py-12 md:py-16 border-t border-grey-light">
          <div className="rounded-xl bg-navy text-white p-8 md:p-12 text-center">
            <h2 className="text-2xl sm:text-3xl font-bold font-heading mb-3">
              Get a Free New Jersey Estimate
            </h2>
...
export default NewJerseyServiceAreasPage;
